...
namespace PascalDotNet.Lexer.Tests.Parsers
{
    ...
    public class ConstantsDeclarationParserTests
    {
        ...
        [Test]
        public void ThrowsUnExpectedTokenExceptionWhenDecimalTokenIsNotFound()
        {
            tokensParser
                .Setup (x => x.WhereTheNextToken (It.IsAny<Func<IToken, bool>>()))
                .Returns (true);
        ...
        [Test]
        public void ThrowsUnExpectedTokenExceptionWhenIntegerTokenIsNotFound()
        {
            tokensParser
                .Setup (x => x.WhereTheNextToken (It.IsAny<Func<IToken, bool>>()))
                .Returns (true);
        ...
        [Test]
        public void ThrowsUnExpectedTokenExceptionWhenLiteralTokenIsNotFound()
        {
            tokensParser
                .Setup (x => x.WhereTheNextToken (It.IsAny<Func<IToken, bool>>()))
                .Returns (true);
